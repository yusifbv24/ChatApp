...
public class ChannelService : IChannelService
{
    ...
    {
        return await _apiClient.GetAsync<List<ChannelDto>>(
    ...
    {
        var response = await _apiClient.PostAsync<CreateChannelResponse>("api/channels", request);
        ...
        DateTime? before = null)
    {
        ...
        return await _apiClient.GetAsync<List<ChannelMessageDto>>(url);
    }
    ...
    {
        return await _apiClient.PostAsync($"api/channels/{channelId}/members/join");
    }
