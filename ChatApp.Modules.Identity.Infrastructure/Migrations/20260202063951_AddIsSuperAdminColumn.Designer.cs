...
namespace ChatApp.Modules.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20260202063951_AddIsSuperAdminColumn")]
    partial class AddIsSuperAdminColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatApp.Modules.Identity.Domain.Entities.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("HeadOfCompanyId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ChatApp.Modules.Identity.Domain.Entities.Company", b =>
                {
                    b.HasOne("ChatApp.Modules.Identity.Domain.Entities.User", "HeadOfCompany")
                        .WithMany()
                        .HasForeignKey("HeadOfCompanyId");

                    b.Navigation("HeadOfCompany");
                });

            modelBuilder.Entity("ChatApp.Modules.Identity.Domain.Entities.Department", b =>
                {
                    b.HasOne("ChatApp.Modules.Identity.Domain.Entities.Company", "Company")
