...
public class UnifiedConversationsController(IMediator mediator) : ControllerBase
{
    ...
    private static UnifiedChatItemDto MapConversation(DirectConversationDto c) => new(
        ...
        OtherUserPosition: c.OtherUserPosition,
        OtherUserRole: c.OtherUserRole,
        OtherUserLastSeenAtUtc: c.OtherUserLastSeenAtUtc,
        MemberCount: null,
        ChannelType: null,
    ...
    private static UnifiedChatItemDto MapChannel(ChannelDto c) => new(
        ...
        LastMessageSenderFullName: c.LastMessageSenderFullName,
    ...
    private static UnifiedChatItemDto MapDepartmentUser(DepartmentUserDto u) => new(
        ...
        OtherUserPosition: u.PositionName,
        OtherUserRole: null,
        OtherUserLastSeenAtUtc: null,
        MemberCount: null,
        ChannelType: null,
